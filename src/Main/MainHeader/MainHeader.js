...
import PressureIcon from '../../assets/Icons/evaporator.svg'
import PrecipitationIcon from '../../assets/Icons/humidity.svg'
...
const MainHeader = ({current , isLight}) => {
    ...
    return (
        ...
        <p className={styles.categoryValue}>{(current.main.temp - 273.15).toFixed()}° - feels like {(current.main.temp - 273.15).toFixed()}°</p>
    </li>
                 <li className={styles.item}>
                     <div className={styles.circle}>
